...
function copyFiletoFolder(dirpath, destFolder) {                // ex. dirpath = "C:\\Users\\DELL\\Downloads\\text.txt"
    let orgFileName = path.basename(dirpath);                   // So "orgFileName" me aega = "text.txt"
    let destFilePath = path.join(destFolder, orgFileName);      // and "destFilePath" me = destFolder + "test.txt"

    fs.copyFileSync(dirpath, destFilePath); // "copyFileSync" ek file ko ek folder me save nhi kr pata hai,
                                            // ie why apn "destFilePath" ko update krte with a file name taki "dirpath" wali
                                            // file ka data "destFilePah" wali file ke data me copy ho jaye.
}                                       
